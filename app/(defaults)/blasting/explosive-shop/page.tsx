...
const BlastingExplosiveShopPage = () => {
        ...
        return (
            <div className="panel flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-white-dark mt-2 max-w-sm">
                    Only <strong>Owner</strong> and <strong>Manager</strong> roles are authorized to view Blasting Explosive Shop records.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-5">
            <div className="flex items-center justify-between">
                <div>
                    <h5 className="font-semibold text-lg dark:text-white-light">🏪 Explosive Shop Payments</h5>
                    <p className="text-white-dark text-xs mt-1">Manage payments made to explosive material suppliers</p>
                </div>
            </div>
            <div className="panel">
                <BlastingExplosiveShop />
            </div>
        </div>
    );
};

export default BlastingExplosiveShopPage;
