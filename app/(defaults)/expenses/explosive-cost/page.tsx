    ...
    return (
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-6">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2"><span>Explosives</span></li>
            </ul>
            <ExpenseCategoryManager category="Explosive Cost" title="வெடிகுண்டு செலவு (Explosive Cost)" />
        </div>
    );
};
