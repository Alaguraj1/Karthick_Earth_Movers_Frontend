        ...
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto dark:text-[#d0d2d6] lg:space-x-2">
                        <div className="dropdown flex shrink-0">
                            ...
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base capitalize">
                                                    ...
                                                    <span className="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">{useSelector((state: IRootState) => state.auth.user?.role) || 'Role'}</span>
                                                </h4>
                                                <button type="button" className="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">
                                                    @{useSelector((state: IRootState) => state.auth.user?.username)}
                                                </button>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <Link href="/users/change-password" className="dark:hover:text-white">
